      ...
      <div className={`modal ${session ? 'remote-browser-modal' : ''}`}>
        ...
        {!session ? (
          ...
          <>
            ...
            <RemoteBrowser sessionId={session.id} onConnected={handleConnected} onDisconnected={handleDisconnected} />
...
function RemoteBrowser({ sessionId, onConnected, onDisconnected }: { sessionId: string; onConnected: () => void; onDisconnected: (message?: string) => void }) {
